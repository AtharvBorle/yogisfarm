            ...
            <div style={{ maxWidth: '1236px', margin: '0 auto', padding: '0 15px' }}>
                ...
                <div className="row mb-40">
                    <div className="col-12 position-relative text-center">
                        <img src="/src/assets/figma/img_25.png" alt="Tea Garden" style={{ width: '100%', height: '350px', objectFit: 'cover', borderRadius: '15px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }} onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src='/assets/imgs/banner/banner-5.png'; }} />
                    </div>
                </div>
                    ...
                    {[
                        {
                            ...
                            icon: "/src/assets/figma/icon_approval.svg"
                        },
                        {
                            ...
                            icon: "/src/assets/figma/icon_gears.svg"
                        },
                        {
                            ...
                            icon: "/src/assets/figma/icon_vision.svg"
                        },
                        {
                    ...
                    {[1, 2, 3, 4, 1, 2, 3, 4].map((item, i) => (
                        <div key={`top-${i}`} style={{ minWidth: '320px', maxWidth: '320px', background: '#fff', borderRadius: '15px', padding: '20px', display: 'flex', flexDirection: 'column', whiteSpace: 'normal', boxShadow: '0 4px 15px rgba(0,0,0,0.04)' }}>
                            <div className="d-flex align-items-center mb-2">
                                <img src={`/src/assets/figma/img_25.png`} alt="User" style={{ width: '40px', height: '40px', borderRadius: '50%', border: '2px solid #0A6738', marginRight: '12px', objectFit: 'cover' }} onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/assets/imgs/theme/icons/user.png'; e.currentTarget.style.border = 'none'; }} />
            ...
            <div className="container" style={{ maxWidth: '1236px' }}>
                <div className="row text-center">
                    <div className="col-lg-3 col-md-6 mb-4">
                        <img src="/src/assets/figma/image_find/chemical_free.svg" alt="100% Chemical Free" style={{ width: '90px', marginBottom: '25px', objectFit: 'contain' }} />
                    ...
                    <div className="col-lg-3 col-md-6 mb-4">
                        <img src="/src/assets/figma/image_find/Cruelty free 1.svg" alt="100% Cruelty Free" style={{ width: '90px', marginBottom: '25px', objectFit: 'contain' }} />
                    ...
                    <div className="col-lg-3 col-md-6 mb-4">
                        <img src="/src/assets/figma/image_find/vegan 1.svg" alt="100% Indian & Vegetarian" style={{ width: '90px', marginBottom: '25px', objectFit: 'contain' }} />
                    ...
                    <div className="col-lg-3 col-md-6 mb-4">
                        <div style={{ position: 'relative', width: '90px', height: '90px', margin: '0 auto 25px auto' }}>
                            <img src="/src/assets/figma/image_find/Vector (1).svg" alt="Circle Background" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'contain' }} />
                            <img src="/src/assets/figma/image_find/freshlayer.svg" alt="Always Fresh" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '60%', height: '60%', objectFit: 'contain' }} />
                        </div>
        ...
        <section className="section-padding pb-5 mb-5" style={{ background: '#FFF' }}>
            <div className="container text-center" style={{ maxWidth: '1236px' }}>
                ...
                <div className="d-flex justify-content-center">
                    <img src="/src/assets/figma/image_find/findus.svg" alt="Partner Logos" style={{ maxWidth: '100%', height: 'auto', objectFit: 'contain' }} />
                </div>
            </div>
        </section>
        </>

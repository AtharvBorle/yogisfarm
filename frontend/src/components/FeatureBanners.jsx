            ...
            <div style={{ maxWidth: '1236px', margin: '0 auto', padding: '0 15px' }}>
                ...
                <div className="row mb-40">
                    <div className="col-12 position-relative text-center">
                        <img src="/src/assets/figma/img_25.png" alt="Tea Garden" style={{ width: '100%', height: '350px', objectFit: 'cover', borderRadius: '15px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }} onError={(e) => e.target.src='/assets/imgs/banner/banner-5.png'} />
                    </div>
                </div>
                    ...
                    {[1, 2, 3, 4, 1, 2, 3, 4].map((item, i) => (
                        <div key={`top-${i}`} style={{ minWidth: '320px', maxWidth: '320px', background: '#fff', borderRadius: '15px', padding: '20px', display: 'flex', flexDirection: 'column', whiteSpace: 'normal', boxShadow: '0 4px 15px rgba(0,0,0,0.04)' }}>
                            <div className="d-flex align-items-center mb-2">
                                <img src={`/src/assets/figma/img_25.png`} alt="User" style={{ width: '40px', height: '40px', borderRadius: '50%', border: '2px solid #0A6738', marginRight: '12px', objectFit: 'cover' }} onError={(e) => { e.target.src = '/assets/imgs/theme/icons/user.png'; e.target.style.border = 'none'; }} />
